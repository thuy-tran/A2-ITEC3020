...
// var volNode = document.getElementById("letter_grade");
// volNode.addEventListener("click", convertGrade, false);


document.getElementById("letter_grade").onclick = convertGrade;
